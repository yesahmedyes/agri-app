...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Future<void> sendOtp() async {
    ...
    await _authRepository.sendCode(phoneNumber!, const Duration(seconds: 60), verificationFailed, verificationComplete, codeSent, codeAutoRetrievalTimeout, resendToken);
  }
}
